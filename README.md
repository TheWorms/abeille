...
|---|---|---|---|---|
| <img src="logos/congelateur.svg" width="22" alt=""> | Congélateur | 0.2.5 | Maison | Inventaire du congélateur, synchronisé avec KitchenOwl. Façade du hub cuisine. |
| <img src="logos/courses.svg" width="22" alt=""> | Courses | 0.2.5 | Maison | Liste de courses partagée, synchronisée avec KitchenOwl. Façade du hub cuisine. |
| <img src="logos/kitchenowl.svg" width="22" alt=""> | Hub KitchenOwl | 0.2.6 | Maison | Hub cuisine KitchenOwl : liste de courses, garde-manger, congélateur, recettes et planning de repas. Base partagée par les… |
| <img src="logos/jardin.svg" width="22" alt=""> | Jardin | 0.3.2 | Maison | Suivi du potager et du jardin : plantations en cours, calendrier d'arrosage, récoltes et rappels de saison. |
| <img src="logos/recettes.svg" width="22" alt=""> | Recettes | 0.2.5 | Maison | Recettes de cuisine, synchronisées avec KitchenOwl. Façade du hub cuisine. |
| <img src="logos/repas.svg" width="22" alt=""> | Repas semaine | 0.3.4 | Maison | Planning des repas de la semaine, synchronisé avec KitchenOwl. Façade du hub cuisine. |
| <img src="logos/stock.svg" width="22" alt=""> | Stock cuisine | 0.2.5 | Maison | Garde-manger et stock des placards, synchronisés avec KitchenOwl. Façade du hub cuisine. |
...
| <img src="logos/budget.svg" width="22" alt=""> | Budget | 0.2.4 | Quotidien | Budget personnel via Actual Budget (passerelle actual-http-api) : soldes des comptes, transactions récentes et suivi des… |
| <img src="logos/maree.svg" width="22" alt=""> | Marée | 0.3.4 | Quotidien | Horaires et coefficients de marée (pleines et basses mers) via l'API api-maree.fr. |
| <img src="logos/soleil-lune.svg" width="22" alt=""> | Soleil & Lune | 1.0.3 | Quotidien | Lever et coucher du soleil, durée du jour, phase et illumination de la lune — calculés localement, sans connexion. |
| <img src="logos/transport.svg" width="22" alt=""> | Transport | 0.2.3 | Quotidien | Prochains passages de train, métro, tram et bus via l'API Navitia (données SNCF / transporteurs). |
...
| <img src="logos/proxmox.svg" width="22" alt=""> | Proxmox | 0.2.3 | Services | État de l'hyperviseur Proxmox VE : nœuds, machines virtuelles et conteneurs LXC, charge CPU/RAM et stockage. |
...
| <img src="logos/instagram.svg" width="22" alt=""> | Instagram | 0.4.3 | Médias | Photos Instagram récupérées via instaloader : dernières publications des comptes suivis, affichées en mosaïque,… |
...
| <img src="logos/musique.svg" width="22" alt=""> | Musique | 0.2.3 | Médias | Lecteur audio branché sur Navidrome (Subsonic) : lecture en fond, favoris et navigation dans la bibliothèque. |
